...
$string['bulk_approved'] = 'Approved {$a} suggestion(s).';
$string['bulk_confirm'] = 'Apply this action to the selected rows?';
$string['bulk_locked'] = 'Locked {$a} string(s).';
$string['bulk_pushed'] = 'Pushed {$a} suggestion(s).';
$string['bulk_rejected'] = 'Rejected {$a} suggestion(s).';
$string['bulk_removed'] = 'Removed {$a} string(s).';
$string['bulk_with_selected'] = 'With selected';
...
$string['export_all_languages'] = 'All languages';
...
$string['modal_source_label'] = 'English source';
...
$string['overlay_progress_label'] = 'approvals';
$string['overlay_toggle'] = 'Improve translations';
$string['overlay_undo'] = 'Undo';
$string['overview'] = 'Overview';
$string['overview_norecentsuggestions'] = 'No pending suggestions.';
$string['overview_nostrings'] = 'No strings have been recorded yet. Enable crowdsourcing and browse the site to start collecting strings.';
$string['overview_notopvoted'] = 'No strings have votes yet.';
$string['overview_pendingsuggestions'] = 'Pending suggestions';
$string['overview_recentsuggestions'] = 'Recent suggestions';
$string['overview_topvoted'] = 'Most-voted strings';
$string['overview_totalstrings'] = 'Strings tracked';
...
$string['settings_adminvote_locks'] = 'Admin approve vote locks immediately';
$string['settings_adminvote_locks_desc'] = 'When enabled, an approve vote cast by a site administrator immediately locks the string, bypassing the normal vote threshold.';
$string['settings_allowed_components'] = 'Components to enable crowdsourcing for';
$string['settings_allowed_components_desc'] = 'Select which components (e.g. mod_forum, core) the voting overlay should be active for. Leave empty to enable for all components. The list is built from strings seen so far; clear the selection to let new components be discovered again.';
...
$string['settings_forcetranslate'] = 'Lock translate mode on';
$string['settings_forcetranslate_desc'] = 'When enabled, the floating "Improve translations" toggle is hidden and the voting overlay is always on for everyone who can use it. When disabled, users switch it on themselves with the toggle.';
