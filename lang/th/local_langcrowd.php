...
$string['bulk_apply'] = 'นำไปใช้';
$string['bulk_approved'] = 'อนุมัติ {$a} ข้อเสนอแนะแล้ว';
$string['bulk_confirm'] = 'ใช้การดำเนินการนี้กับแถวที่เลือกหรือไม่?';
$string['bulk_locked'] = 'ล็อก {$a} สตริงแล้ว';
$string['bulk_pushed'] = 'ส่งเข้าชุดภาษา {$a} ข้อเสนอแนะแล้ว';
$string['bulk_rejected'] = 'ปฏิเสธ {$a} ข้อเสนอแนะแล้ว';
$string['bulk_removed'] = 'นำออก {$a} สตริงแล้ว';
$string['bulk_with_selected'] = 'กับรายการที่เลือก';
...
$string['export_all_languages'] = 'ทุกภาษา';
...
$string['modal_source_label'] = 'ต้นฉบับภาษาอังกฤษ';
...
$string['overlay_progress_label'] = 'การอนุมัติ';
$string['overlay_toggle'] = 'ปรับปรุงการแปล';
$string['overlay_undo'] = 'เลิกทำ';
$string['overview'] = 'ภาพรวม';
$string['overview_norecentsuggestions'] = 'ไม่มีข้อเสนอแนะที่รอดำเนินการ';
$string['overview_nostrings'] = 'ยังไม่มีการบันทึกสตริง เปิดใช้งานการแปลแบบร่วมสร้างและเรียกดูเว็บไซต์เพื่อเริ่มเก็บสตริง';
$string['overview_notopvoted'] = 'ยังไม่มีสตริงที่มีคะแนน';
$string['overview_pendingsuggestions'] = 'ข้อเสนอแนะที่รอดำเนินการ';
$string['overview_recentsuggestions'] = 'ข้อเสนอแนะล่าสุด';
$string['overview_topvoted'] = 'สตริงที่มีคะแนนมากที่สุด';
$string['overview_totalstrings'] = 'สตริงที่ติดตาม';
...
$string['select_all'] = 'เลือกทั้งหมด';
$string['settings'] = 'การตั้งค่าการแปลภาษาแบบร่วมสร้าง';
$string['settings_adminvote_locks'] = 'การโหวตอนุมัติของผู้ดูแลระบบล็อกทันที';
$string['settings_adminvote_locks_desc'] = 'เมื่อเปิดใช้งาน การโหวตอนุมัติที่ส่งโดยผู้ดูแลระบบเว็บไซต์จะล็อกสตริงทันที โดยข้ามเกณฑ์คะแนนปกติ';
$string['settings_allowed_components'] = 'คอมโพเนนต์ที่เปิดใช้งานการแปลแบบร่วมสร้าง';
$string['settings_allowed_components_desc'] = 'เลือกคอมโพเนนต์ (เช่น mod_forum, core) ที่ควรเปิดใช้งานอินเทอร์เฟซการลงคะแนน เว้นว่างเพื่อเปิดใช้งานสำหรับทุกคอมโพเนนต์ รายการสร้างจากสตริงที่พบมาแล้ว ล้างการเลือกเพื่อให้ค้นพบคอมโพเนนต์ใหม่อีกครั้ง';
...
$string['settings_forcetranslate'] = 'ล็อกโหมดแปลให้เปิดตลอด';
$string['settings_forcetranslate_desc'] = 'เมื่อเปิดใช้งาน ปุ่มสลับ "ปรับปรุงการแปล" แบบลอยจะถูกซ่อน และอินเทอร์เฟซการลงคะแนนจะเปิดตลอดเวลาสำหรับทุกคนที่ใช้งานได้ เมื่อปิดใช้งาน ผู้ใช้จะเปิดเองด้วยปุ่มสลับ';
